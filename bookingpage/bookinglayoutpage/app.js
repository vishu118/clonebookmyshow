...
chooseseats.addEventListener("mouseover", (e) => {
  if (e.target.innerText == "1") {
    vechile.src = "/bookinglayoutpage/images/bycycle.png";
  } else if (e.target.innerText == "2") {
    vechile.src = "/bookinglayoutpage/images/scooter.png";
  } else if (e.target.innerText == "3") {
    vechile.src = "/bookinglayoutpage/images/auto.png";
  } else if (e.target.innerText == "4") {
    vechile.src = "/bookinglayoutpage/images/minicar.png";
  } else if (e.target.innerText == "5") {
    vechile.src = "/bookinglayoutpage/images/car.png";
  } else {
    vechile.src = "/bookinglayoutpage/images/bus.png";
  }
});
